...
export default class back2life extends React.Component {
	...
	append_slider()
	{
		...
		for(var i = 0; i < this.data.length; i++) {
			op.push(<div class='card' key={i}>
				<div class='img' style={{ background: `rgba(0, 0, 0, 0) url('${ this.data[i].img }') no-repeat scroll center center / cover`}}></div>
		...
		return ( 
			<div id='back2life'>
				...
				<div class='rows2 mt-3'>
					{ this.append_slid() }
					<div ref='l' class='arr l'>06</div>
					<div ref='r' class='arr r'>04</div>
				</div>
			</div>
		);
	}
