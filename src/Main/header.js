...
export default class header extends React.Component {
		...
		this.tr = {
			...
			ham:{ is:true, can:true,
				...
				getRotation: function(tar) {
					var matrix = tar.css("-webkit-transform") ||
	...
	componentDidMount() {
		...
		$(this.refs.menu).children('.b').click(function(){
	...
	scrollTo(e)
	{
		...
		$('document, html').animate({ scrollTop:e },t > 1000 ? 1000 : t ,'easeOutQuart')
	}
			...
			<div ref='main' id='header'>
				<div class='rows'>
					...
					<div ref='menu' class='header-menu'>
						<div id='hb0' class='b'>公司簡介</div>
						<div id='hb1' class='b'>作業流程</div>
						<div id='hb2' class='b'>可製品項</div>
						<div id='hb3' class='b'>聯絡我們</div>
					</div>
